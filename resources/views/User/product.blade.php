        ...
        <div class="col-md-8">
            ...
            <div class="card">
                <div class="card-header">
                    Product List <a href="{{ route('product.create') }}" class="btn btn-success btn-sm float-right" >Add New</a>
                </div>
                    ...
                    <table class="table table-sm">
                        ...
                        @foreach($products as $value)
                            <tr>
                                ...
                                <td>{{$value->status}}</td>
                                <td>
                                    <a href="{{ route('product.edit',$value->id) }}" class="btn btn-info btn-sm" >edit</a>
